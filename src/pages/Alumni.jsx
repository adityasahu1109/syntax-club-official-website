          ...
          <div className="mb-12 text-center md:text-left flex flex-col items-center md:items-start">
            <div className="flex flex-col gap-2 items-center md:items-start">
              ...
              <h1 className="text-slate-900 dark:text-slate-100 text-4xl md:text-5xl font-black leading-tight tracking-tighter">
                The <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">Legacy Network</span>
              </h1>
              <p className="text-slate-600 dark:text-slate-400 text-base md:text-lg max-w-xl mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {alumniData.map((alumnus, index) => (
            <FadeIn key={alumnus.id} direction="up" delay={index * 100} className="w-full">
              <div
                className="flex items-center gap-6 bg-white dark:bg-slate-900/40 p-6 rounded-xl border border-slate-200 dark:border-primary/10 shadow-sm hover:border-primary/40 transition-all group w-full"
              >
                {/* Avatar */}
                ...
                <div className="flex flex-col flex-1 min-w-0">
                  <p className="text-slate-900 dark:text-slate-100 text-xl font-bold group-hover:text-primary transition-colors truncate">
                    {alumnus.name}
                  </p>
                ...
                <a
                  ...
                  className="shrink-0 size-10 flex items-center justify-center rounded-lg bg-slate-100 dark:bg-primary/5 text-slate-500 dark:text-primary/60 hover:bg-primary hover:text-black transition-all"
