      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {alumniData.map((alumnus) => (
            <div
              key={alumnus.id}
              className="flex items-center gap-6 bg-white dark:bg-slate-900/40 p-6 rounded-xl border border-slate-200 dark:border-primary/10 shadow-sm hover:border-primary/40 transition-all group"
            >
              {/* Avatar */}
