...
const StatCard = ({ icon, label, value, suffix }) => {
  ...
  return (
    <div ref={ref} className="flex min-w-[150px] md:min-w-[200px] flex-1 flex-col gap-2 md:gap-3 p-4 md:p-6 items-center text-center hover:-translate-y-1 transition-transform">
      <span className="material-symbols-outlined text-[32px] md:text-[40px] text-primary">{icon}</span>
      <p className="text-slate-400 dark:text-slate-300 text-base md:text-lg font-medium leading-normal">{label}</p>
      <p className="text-slate-900 dark:text-white tracking-light text-3xl md:text-4xl font-black leading-tight">{count}{suffix}</p>
    </div>
  );
};
...
const Home = () => {
  return (
    <div className="w-full overflow-hidden">
      ...
      <div className="relative w-full min-h-[92vh] flex flex-col items-center justify-center overflow-hidden">
        {/* Animated Background */}
      ...
      <FadeIn direction="up">
        <div className="w-full max-w-[1200px] mx-auto py-12">
          <div className="flex flex-wrap gap-6 px-6 lg:px-0">
      ...
      {/* Who We Are Section */}
      <div className="w-full max-w-[1200px] mx-auto py-16 px-6 lg:px-0">
        <div className="flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FadeIn delay={100} direction="up" className="h-full">
              <div className="flex flex-col h-full bg-white/5 dark:bg-white/5 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-md">
      ...
      <div className="w-full max-w-[1200px] mx-auto py-16 px-6 lg:px-0">
        <FadeIn direction="up">
          <div className="flex flex-col gap-8">
            <h2 className="text-slate-900 dark:text-white text-3xl font-black leading-tight tracking-[-0.015em] text-center md:text-left">Glimpses</h2>
