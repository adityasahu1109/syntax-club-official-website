            ...
            <div className="group flex flex-col w-full bg-white/5 dark:bg-primary/5 border border-white/10 rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300 shadow-sm hover:shadow-[0_0_20px_rgba(6,245,249,0.08)] relative">
              ...
              <div className="relative aspect-video overflow-hidden bg-black/40 border-white/5 border-b">
                ...
                <div className="absolute top-3 left-3 flex flex-wrap gap-2">
                  <span className="px-2.5 py-1 bg-black/50 backdrop-blur-md text-primary text-[10px] font-bold rounded-full uppercase tracking-widest border border-primary/20">
                    {project.category}
                  </span>
                  {project.liveUrl ? (
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="flex gap-3 mt-auto pt-4 border-t border-slate-200 dark:border-white/5 relative z-20">
                  ...
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border border-slate-300 dark:border-white/15 text-slate-300 font-bold text-xs uppercase tracking-wider hover:border-primary hover:text-primary transition-all"
                  >
                  ...
                  {project.liveUrl ? (
                    ...
                    <span className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg bg-white/5 border-white/10 border text-white text-slate-400 font-bold text-xs uppercase tracking-wider cursor-not-allowed select-none">
